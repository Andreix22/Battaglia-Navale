...
extern void generaIndici(char campoGiocatore [][COL], char*, int*, int*, int, int);
extern int controlloIndici(char campoGiocatore [][COL], char, int, int, int, int);
extern void caricaNaviCasuale(char campoGiocatore[][COL], int);
extern void caricaNaviManuale(char campoGiocatore[][COL], int);
